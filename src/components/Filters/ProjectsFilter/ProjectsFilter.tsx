...
import { useGetFaculties, useGetFacultyDepartment, useGetResearchCenters } from '@app/hooks/query/Faculty';
...
function ProjectsFilter() {
	...
	const {
		...
		isError: researchCentersIsError
	} = useGetResearchCenters(i18n.language);
	...
	return (
		<div className='flex flex-col'>
			...
			{
				!researchCentersIsError && researchCenters &&
				<div className='mt-2'>
					<AutoComplete
						options={
							[
						...
						placeholder={t('researchCenters') as string}
						urlKey='researchCenters'
					/>
				</div>
			}
			{
